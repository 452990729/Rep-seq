...
my_pdf=$3
$html2pdf_path/wkhtmltopdf --page-size A4 --quiet --disable-external-links --print-media-type -O Portrait -T 20mm -R 10mm -B 30mm -L 10mm cover $my_cover toc --toc-text-size-shrink 1 --footer-center '[page]/[toPage]' --header-spacing 5 $my_html --page-offset -1 --footer-center '[page]/[toPage]' $my_pdf
