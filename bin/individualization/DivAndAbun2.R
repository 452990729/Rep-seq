...
clones <- estimateAbundance(datain, group="SAMPLE", ci=0.95, clone="CLONE",
                            nboot=200)
#sample_colors <- c("PB7"="red", "SB7"="blue")
plot(clones, legend_title="Samples", plot.title = element_text(hjust = 0.5, size=22, face="bold"),
...
sample_div <- rarefyDiversity(datain, group="SAMPLE", min_q=0, max_q=32, step_q=0.05, clone="CLONE",
                              ci=0.95, nboot=200)
